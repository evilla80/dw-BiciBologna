...
def download_bici_2020_2025():
    ...
    where_clause = 'data >= "2020-01-01" and data <= "2025-12-31"'
    ...
    if response.status_code == 200:
        with open('colonnine_2020_2025.csv', 'wb') as f:
            f.write(response.content)
        print("File salvato con successo: colonnine_2020_2025.csv")
    else:
...
def download_meteo_data():
    ...
    params = {
        "latitude": 44.49,
        "longitude": 11.34,
        "start_date": "2020-01-01",  # Nuovo inizio
